...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // The AI layer is wrapped in its own error boundary — any crash inside
  // the advisor degrades silently rather than taking down the dashboard.
  return (
    <AiErrorBoundary>
      <AiProvider>
        <div className="min-h-screen bg-surface-50 light-mode-page text-surface-900">
          ...
          {/* NextNova AI — floating assistant available on every dashboard page */}
          <AiAssistant />
        </div>
      </AiProvider>
    </AiErrorBoundary>
